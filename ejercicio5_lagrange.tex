...
Tenemos $n+1 = 3$ puntos, por lo que el polinomio interpolante
tiene grado $\leq 2$:
\[
  (x_0,\,y_0)=(0,1),\quad
  (x_1,\,y_1)=(1,3),\quad
...
\begin{tabular}{cccc}
  \toprule
  $x_i$ & $P(x_i)$ & $y_i$ & \textcolor{green!50!black}{OK} \\
  \midrule
...
El polinomio pasa exactamente por los tres puntos dados. \qed
