...
def search():
    ...
    # We scan propellants between 27800 and 28600 in steps of 100
    for prop in np.arange(27800, 28600, 100):
        print(f"\n--- Sweeping prop={prop} kg ---")
        # 120 angles
        ...
        for ang in angles:
            ...
            if min_d < 60000000.0:  # closer than 60,000 km to the Moon
                print(f"MATCH: Ang={ang:.4f} rad ({np.degrees(ang):.1f} deg) | Prop={prop} kg | "
